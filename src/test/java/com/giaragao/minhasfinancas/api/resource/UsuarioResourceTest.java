...
import com.giaragao.minhasfinancas.service.LancamentoService;
...
public class UsuarioResourceTest {
	...
	@Test
	public void deveRetornarBadRequestAoObterErroAutenticao() throws Exception {
		String email = "usuario@email.com";
		String senha = "123";
	...
	public void deveCriarUmNovoUsuario() throws Exception {
		...
		Mockito.when(service.salvarUsusario(Mockito.any(Usuario.class))).thenReturn(usuario);		
		String json = new ObjectMapper().writeValueAsString(dto);
	...
	public void deveRetornarBadRequestAoCriarUsuarioInvalido() throws Exception {
		...
		Mockito.when(service.salvarUsusario(Mockito.any(Usuario.class))).thenThrow(RegraNegocioException.class);		
		String json = new ObjectMapper().writeValueAsString(dto);
