...
import com.giaragao.minhasfinancas.model.repository.UsuarioRepository;
import com.giaragao.minhasfinancas.service.impl.UsuarioServiceImpl;
...
public class UsuarioServiceTest {
	...
	public void deveSalvarUmUsuario() {
		...
		Usuario usuarioSalvo = service.salvarUsusario(new Usuario());
	...
	public void naoDeveSalvarUsuarioComEmailJaCadastrado() {
		...
		org.junit.jupiter.api.Assertions.assertThrows(RegraNegocioException.class, () -> service.salvarUsusario(usuario));
